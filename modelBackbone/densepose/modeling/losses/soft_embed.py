...
from modelBackbone.densepose.data.meshes.catalog import MeshCatalog
from modelBackbone.densepose.modeling.cse.utils import normalize_embeddings, squared_euclidean_distance_matrix
