...
from modelBackbone.detectron2.checkpoint import DetectionCheckpointer
from modelBackbone.detectron2.config import CfgNode
from modelBackbone.detectron2.engine import DefaultTrainer
from modelBackbone.detectron2.evaluation import (
    DatasetEvaluator,
    DatasetEvaluators,
    inference_on_dataset,
    print_csv_format,
)
from modelBackbone.detectron2.solver.build import get_default_optimizer_params, maybe_add_gradient_clipping
from modelBackbone.detectron2.utils import comm
from modelBackbone.detectron2.utils.events import EventWriter, get_event_storage

from modelBackbone.densepose import DensePoseDatasetMapperTTA, DensePoseGeneralizedRCNNWithTTA, load_from_cfg
from modelBackbone.densepose.data import (
    DatasetMapper,
...
from modelBackbone.densepose.evaluation.d2_evaluator_adapter import modelBackbone.detectron2COCOEvaluatorAdapter
from modelBackbone.densepose.evaluation.evaluator import DensePoseCOCOEvaluator, build_densepose_evaluator_storage
from modelBackbone.densepose.modeling.cse import Embedder
