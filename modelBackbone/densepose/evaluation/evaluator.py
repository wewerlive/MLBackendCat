...
from modelBackbone.detectron2.data import MetadataCatalog
from modelBackbone.detectron2.evaluation import DatasetEvaluator
from modelBackbone.detectron2.structures import BoxMode
from modelBackbone.detectron2.utils.comm import gather, get_rank, is_main_process, synchronize
from modelBackbone.detectron2.utils.file_io import PathManager
from modelBackbone.detectron2.utils.logger import create_small_table

from modelBackbone.densepose.converters import ToChartResultConverter, ToMaskConverter
from modelBackbone.densepose.data.datasets.coco import maybe_filter_and_map_categories_cocoapi
from modelBackbone.densepose.structures import (
