...
from modelBackbone.detectron2.structures import Instances

from modelBackbone.densepose.converters.base import IntTupleBox
from modelBackbone.densepose.data.utils import get_class_to_mesh_name_mapping
from modelBackbone.densepose.modeling.cse.utils import squared_euclidean_distance_matrix
from modelBackbone.densepose.structures import DensePoseDataRelative
...
class DensePoseCSEBaseSampler(DensePoseBaseSampler):
    """
    Base DensePose sampler to produce DensePose data from modelBackbone.densepose predictions.
