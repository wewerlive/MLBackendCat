...
from modelBackbone.detectron2.structures import BitMasks, Instances

from modelBackbone.densepose.converters import ToMaskConverter


class MaskFromDensePoseSampler:
    """
    Produce mask GT from modelBackbone.densepose predictions
