...
from modelBackbone.densepose import add_densepose_config
from modelBackbone.densepose.vis.base import CompoundVisualizer
from modelBackbone.densepose.vis.densepose_results import DensePoseResultsFineSegmentationVisualizer
from modelBackbone.densepose.vis.extractor import create_extractor, CompoundExtractor
from modelBackbone.detectron2.config import get_cfg
from modelBackbone.detectron2.data.detection_utils import read_image
from modelBackbone.detectron2.engine.defaults import DefaultPredictor


class DensePose:
    """
    DensePose used in this project is from modelBackbone.detectron2 (https://github.com/facebookresearch/detectron2).
